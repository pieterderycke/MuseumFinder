...
namespace MuseumFinder
{
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            // Register for MVVM messages
            Messenger.Default.Register<ShowDirectionsMessage>(this, OnShowDirectionsMessageReceived);
            Messenger.Default.Register<ShowErrorMessage>(this, OnShowErrorMessageReceived);
            Messenger.Default.Register<CallPhoneNumberMessage>(this, OnCallPhoneNumberMessageReceived);
            Messenger.Default.Register<OpenWebPageMessage>(this, OnOpenWebPageMessageReceived);
            Messenger.Default.Register<CreateMailMessage>(this, OnCreateMailMessageReceived);
        ...
        private void OnCallPhoneNumberMessageReceived(CallPhoneNumberMessage message)
        {
            ...
            task.PhoneNumber = message.PhoneNumber;
            task.Show();
        }
        ...
        private void OnCreateMailMessageReceived(CreateMailMessage message)
        {
            EmailComposeTask task = new EmailComposeTask();
            task.To = message.EmailAddress;
            task.Show();
        }
    }
}