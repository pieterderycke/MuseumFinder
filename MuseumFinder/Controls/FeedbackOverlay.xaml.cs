...
namespace MuseumFinder.Controls
{
    public partial class FeedbackOverlay : UserControl
    {
        ...
        private void SetupFirstMessage()
        {
            ...
            this.YesText = AppResources.RatingYesButtonText;
            this.NoText = AppResources.RatingNoButtonText;
        }
        ...
        private void SetupFeedbackMessage()
        {
            ...
            this.Message = AppResources.FeedbackMessage;
            this.YesText = AppResources.FeedbackYesButtonText;
            this.NoText = AppResources.FeedbackNoButtonText;
        }
        ...
        private void Feedback()
        {
            ...
            string body = string.Format(AppResources.FeedbackBodyText,
            ...
            email.To = LicenseKeys.EmailAddress;
